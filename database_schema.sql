-- Minimal test block for project_bug_reports foreign key debug
-- Ensure referenced tables exist and types match
...
CREATE TABLE `project_bug_reports` (
  ...
  CONSTRAINT `project_bug_reports_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
  CONSTRAINT `project_bug_reports_ibfk_2` FOREIGN KEY (`reported_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
-- --------------------------------------------------------
